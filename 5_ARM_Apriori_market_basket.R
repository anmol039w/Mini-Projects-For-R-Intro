...
#
# The data contains 9,835 transactions
#
# 327 transactions per day 
#
# Roughly 30 transactions per hour in a 12-hour business day
#
...
# We cant have rules with support = 0.1 and confidence = 0.8
apriori(groceries) 

# Set the parameters
# Apriori only creates rules with one item in the RHS (Consequent)! The default value in 
# APparameter for minlen = 1. 
