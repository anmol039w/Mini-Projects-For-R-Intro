...
#
# It has one collection composed by 5,574 English, 
...
# library(wordcloud) # Plot a cloud of words shared across documents
# library(e1071) # Library for naive Bayes classifier, support vector machines, shortest path computation
...
#setwd("/Users/2_ML/1_EXAMPLES/4_Classification")
...
# Standardize or clean the SMSs: removing
...
# (d) Do stemming: Reduce the words to root form: 
...
# Splitting text document into words, create document term matrix
...
# Results: Looking at the table, we can see that a total of only 6 + 30 = 36 of the 
# 1,390 SMS messages were incorrectly classified (2.6 percent). 
# Among the errors were 6 out # of 1,207 ham messages that were 
# misidentified as spam, and 30 of the 183 spam
